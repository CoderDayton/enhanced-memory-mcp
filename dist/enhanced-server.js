                ...
                try {
                    ...
                    if (request.method === 'initialize') {
                        ...
                        try {
                            switch (toolName) {
                                case 'add_memory':
                                    result = await memoryStore.addMemory(args.content, args.type, args.metadata);
                                    break;
                                ...
                                case 'get_similar_memories':
                                    result = await memoryStore.getSimilarMemories(args.content, args.limit, args.threshold);
                                    break;
                                case 'clear_cache':
